...
public class IterativeMergeOrchestratorTests : MockFileSystemTestBase
{
	...
	{
		// Act & Assert
		Assert.ThrowsException<ArgumentNullException>(() => IterativeMergeOrchestrator.PrepareFileGroupsForMerging(null!, "*.txt"));
	}
	...
	{
		// Act & Assert
		Assert.ThrowsException<ArgumentNullException>(() => IterativeMergeOrchestrator.PrepareFileGroupsForMerging(TestDirectory, null!));
	}
