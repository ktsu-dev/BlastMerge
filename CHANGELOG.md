...
- refactor: clear the analyzer findings on the binary-detection change ([@Claude](https://github.com/Claude))
- fix: validate the binary fixture path instead of letting Path.Combine drop the test directory ([@Claude](https://github.com/Claude))
- fix: skip binary files instead of merging them as UTF-8 text [minor] ([@Claude](https://github.com/Claude))

## v1.6.0 (minor)

Changes since v1.5.0:

- refactor: clear the analyzer findings on the line-ending change ([@Claude](https://github.com/Claude))
- test: combine the batch test path through the mock file system ([@Claude](https://github.com/Claude))
- fix: preserve the sources' line endings across every merge path [minor] ([@Claude](https://github.com/Claude))
...
- test: use the MSTest assertions the analyzers ask for ([@Claude](https://github.com/Claude))
- test: cover the command line handler's argument dispatch ([@Claude](https://github.com/Claude))
- feat: ship BlastMerge as a dotnet tool [minor] ([@Claude](https://github.com/Claude))
...
- Merge 881f45e86b19f9c90378a1aa6cc50ffcb6ef5610 into 48ede99e477640286bcc0251eae7563c0a332825 ([@matt-edmondson](https://github.com/matt-edmondson))
- Enhance derived cursor rules and update test structures ([@matt-edmondson](https://github.com/matt-edmondson))
- Fix build errors and improve code quality ([@matt-edmondson](https://github.com/matt-edmondson))
- Split classes into their own files and convert to records ([@matt-edmondson](https://github.com/matt-edmondson))
- Refactor command line handling to use CommandLineParser library ([@matt-edmondson](https://github.com/matt-edmondson))
...
- Refactor project structure and enhance package management ([@matt-edmondson](https://github.com/matt-edmondson))
